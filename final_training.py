...
def train(
    ...
    dnn.fit(train_generator,
        ...
        steps_per_epoch    = len(train_idxs) * 10 // batch_size, 
        epochs             = max_epochs,
        callbacks          = callbacks)
...
if __name__ == "__main__":
    ...
    # High X and Z resolution, to offer context for the mostly vertical kidney, ureter, bladder structure
    best_window = (192, 160, 128) 
